		...
		if (CEnemyCastBar.bStatus) then
			...
			if (arg1) then
				...
				if ( GetLocale() == "frFR" ) then
					...
					for mob, damage, crap, spell in string.gfind(arg1, CEnemyCastBar_SPELL_DAMAGE_SELFOTHER) do
				...
				for spell, mob, damage, crap in string.gfind(arg1, CEnemyCastBar_SPELL_CRITS_SELFOTHER) do
